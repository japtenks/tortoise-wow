...
enum eConfigUInt32Values
{
    ...
    CONFIG_UINT32_QUEST_SHOP_TOKEN_REWARD,
    CONFIG_UINT32_QUEST_SHOP_MILESTONE_INTERVAL,
    CONFIG_UINT32_QUEST_SHOP_MILESTONE_REWARD,
...
enum eConfigBoolValues
{
    ...
    CONFIG_BOOL_QUEST_SHOP_TOKENS_ENABLED,
    CONFIG_BOOL_QUEST_SHOP_TOKENS_ANNOUNCE,
